...
void main() {
    ...
    if (isVertical == 1.0) {
        v_pixelCoords[0] = a_texCoord0 + vec2(0.0, v_texelSize * -8.0f);
        v_pixelCoords[1] = a_texCoord0 + vec2(0.0, v_texelSize * -7.0f);
        v_pixelCoords[2] = a_texCoord0 + vec2(0.0, v_texelSize * -6.0f);
        v_pixelCoords[3] = a_texCoord0 + vec2(0.0, v_texelSize * -5.0f);
        v_pixelCoords[4] = a_texCoord0 + vec2(0.0, v_texelSize * -4.0f);
        v_pixelCoords[5] = a_texCoord0 + vec2(0.0, v_texelSize * -3.0f);
        v_pixelCoords[6] = a_texCoord0 + vec2(0.0, v_texelSize * -2.0f);
        v_pixelCoords[7] = a_texCoord0 + vec2(0.0, v_texelSize * -1.0f);
        v_pixelCoords[9] = a_texCoord0 + vec2(0.0, v_texelSize * 1.0f);
        v_pixelCoords[10] = a_texCoord0 + vec2(0.0, v_texelSize * 2.0f);
        v_pixelCoords[11] = a_texCoord0 + vec2(0.0, v_texelSize * 3.0f);
        v_pixelCoords[12] = a_texCoord0 + vec2(0.0, v_texelSize * 4.0f);
        v_pixelCoords[13] = a_texCoord0 + vec2(0.0, v_texelSize * 5.0f);
        v_pixelCoords[14] = a_texCoord0 + vec2(0.0, v_texelSize * 6.0f);
        v_pixelCoords[15] = a_texCoord0 + vec2(0.0, v_texelSize * 7.0f);
        v_pixelCoords[16] = a_texCoord0 + vec2(0.0, v_texelSize * 8.0f);
    }
    else {
