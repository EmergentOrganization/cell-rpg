...
public class WindWaker extends Entity{
    private static final int RENDERS_PER_INSERT = 1;  // TODO: (improvement) more inserts for more intense wind
    ...
    private void addWindPixel(){
        ...
        newEffect.load(Gdx.files.internal("particleEffects/wind2.p"), Gdx.files.internal("particleEffects"));
