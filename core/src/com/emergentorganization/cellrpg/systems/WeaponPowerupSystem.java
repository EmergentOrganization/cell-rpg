...
/**
 * Handles weapon powerups and returning of weapon to normal after powerup has worn off.
 */
public class WeaponPowerupSystem extends IntervalEntityProcessingSystem {
    private final Logger logger = LogManager.getLogger(getClass());
    static final int FREQ = 1;

    public WeaponPowerupSystem() {
